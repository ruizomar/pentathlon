		...
		<!-- <div id="contenedor" class="col-md-offset-2 col-md-8 form-group">
			...
			<div class="col-md-9">
				<div class="col-md-7">
					...
					<h4>
						{{ Form::label('matricula','Matricula: ',array('class' => 'label label-success')) }}
					</h4>
					<h4>
						{{ Form::label('cargo','Cargo actual: ',array('class' => 'label label-primary')) }}
					</h4>
					<h4>
						{{ Form::label('companiasysubzonas','Ubicacion actual: ',array('class' => 'label label-default')) }}
					</h4>
				</div>
				<div class="col-md-5">
	...
	<script>
		function encontrado (id) {
			$.post('cargos/buscar',{id:id}, function(json) {
				...
				$('label[for=matricula]').text('Matricula: '+json.matricula);
				$('label[for=cargo]').text('Cargo: '+json.cargo);
				$('label[for=companiasysubzonas]').text('Ubicacion: '+json.companiasysubzonas);
				if(!json.cargo){
