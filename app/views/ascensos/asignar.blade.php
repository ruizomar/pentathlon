...
@section('elemento')
	...
	<div class="col-md-12" style="right: 10px;">
		...
		<div class="text-center ascensos col-md-3">
			<br>
			<div class="col-md-12" style="padding:20px;" onclick="ascender()">
				<p>El elemento ascenderá a <label id="ascender" class="label label-success" style="font-size: 16px;">CADETE</label></p>
			</div>
		</div>
	</div>
	<div class="col-md-12" style="right: 10px;">
		...
		<div class="tour-4 tour-5 tour-6 calificaciones requisitos col-md-3" style="left:10px;">
			<h4 class="titulo text-center">Exámenes</h4>
			<div id="calificaciones"></div>
		</div>
	</div>
...
@section('scripts2')
	...
	var elemento_id = 0;
		...
		function ascender () {
			swal({
					title: '¿Estás seguro?',
					text: 'Se le asignara el nuevo grado al elemento',
					type: 'warning',
